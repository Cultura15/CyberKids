...
public class InfoSortingLeaderboardController {

    @Autowired
    private InfoSortingLeaderboardService leaderboardService;
    ...
    public ResponseEntity<?> updateScoreAndTime(@PathVariable String robloxId) {
        ...
        InfoSortingLeaderboardEntry updatedEntry = leaderboardService.updateStudentTotalScoreAndTime(student);
