...
@Service
public class InfoSortingLeaderboardService {

    @Autowired
    private InfoSortingLeaderboardRepo leaderboardRepo;
    ...
    public InfoSortingLeaderboardEntry updateStudentTotalScoreAndTime(Student student) {
        ...
        InfoSortingLeaderboardEntry leaderboardEntry = leaderboardRepo
                .findByStudent(student)
                .orElse(new InfoSortingLeaderboardEntry(student, totalPoints, totalTimeTaken));
